{
  inputs = {
    ...
    csvs-ui = {
      url = "git+https://source.fetsorn.website/fetsorn/csvs-ui?ref=main";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    csvs-sh = {
      url = "git+https://source.fetsorn.website/fetsorn/csvs-sh?ref=main";
      inputs.nixpkgs.follows = "nixpkgs";
    };
  };
  outputs = inputs@{ nixpkgs, ... }:
    ...
    in eachSystem defaultSystems (system:
      ...
      in {
        ...
        defaultApp = inputs.csvs-ui.packages.${system}.csvs-ui-backend-local;
      });
}
